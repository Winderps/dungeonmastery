...
import com.fingersome.dungeonmasterycore.network.PacketOpenCharacterInventory;
...
public class KeyHandler 
{
	...
	public KeyBinding key = new KeyBinding("Character Inventory", 
...
//				if (!event.player.capabilities.isCreativeMode)
					DungeonMasteryCore.packetPipeline.sendToServer(new PacketOpenCharacterInventory(event.player));
//				else {
