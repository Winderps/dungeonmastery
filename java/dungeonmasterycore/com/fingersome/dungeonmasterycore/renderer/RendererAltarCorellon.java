...
public class RendererAltarCorellon extends TileEntitySpecialRenderer {

	private ModelAltarCorellon model;

	private static final ResourceLocation texture = new ResourceLocation(CoreReference.MOD_ID, "textures/models/TextureAltarCorellon.png");
	
	public RendererAltarCorellon(){
		this.model = new ModelAltarCorellon();
	}
