...
import com.fingersome.dungeonmastery.model.ModelCorpseGrave;
...
public class RendererCorpseGrave extends TileEntitySpecialRenderer 
{
	...
	private static final ResourceLocation texture = new ResourceLocation(References.MOD_ID, "textures/model/TextureCorpseGrave.png");
	
	public RendererCorpseGrave()
	{
		this.model = new ModelCorpseGrave();
	}
