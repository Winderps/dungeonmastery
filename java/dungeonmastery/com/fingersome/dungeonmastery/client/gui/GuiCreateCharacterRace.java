...
public class GuiCreateCharacterRace extends GuiScreen 
{
	...
	public final ResourceLocation texture = new ResourceLocation(com.fingersome.dungeonmastery.lib.References.MOD_ID, "textures/gui/creation/GuiCharacterCreationRace.png");
	...
	protected void actionPerformed(GuiButton button, EntityPlayer player, World world, int x, int y, int z)
		{
			...
			case 20: player.openGui(DungeonMastery.instance, 1, world, x, y, z);
			}
		}
